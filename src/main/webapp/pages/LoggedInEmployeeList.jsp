...
<head>
 ...
 <script>
 		...
 		function updates(){
 			$.getJSON("employeeStatusList",function(data){
 				$("#tbody").empty()
 				var sno=1;
 				$.each(data.employeeList,function(){
 					$("#tbody").append("<tr>"
 							...
 							+"<td>"+( this['employeeStatusId']==4 ?
 									"<button type='button' class='btn btn-success'></button>" :
 									"<button type='button' class='btn btn-danger'></button>")+"</td>"
							+"</tr>" );
 							sno++;
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="navAffiliates"><i class="icon-user"></i><span class="hidden-tablet">Affiliates Details</span></a></li>
						<li><a href="#"><i class="icon-bar-chart"></i><span class="hidden-tablet">LoggedIn-Employee</span></a></li>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon book"></i><span class="break"></span> LoggedIn-Employee </h2>
			...
			<form  method="post" id="formId">
				...
				<div align="right">
					<!-- <input type="Submit" value="Submit" id="" class="btn btn-primary"> -->
				</div>
						</form>		
