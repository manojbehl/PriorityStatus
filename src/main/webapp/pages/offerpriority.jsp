 ...
 <script>
 		$(document).ready(function(){
 			...
 			$("#setPriorityButton").click(function(){
 				...
 				$("#formId").attr('action','<%=request.getContextPath()%>/updateOfferPriority');
 			});
 		});
 		function updates(){
 			$.getJSON("offerList",function(data){
 				$("#tbody").empty()
 				var sno=1;
 				
 				$.each(data.listObjectAction,function(){
 					$("#tbody").append("<tr>"
 							+"<td style='text-align: center; color: #3A0756; font-size: 15px'>"+sno+"<input type=hidden name='Id' value='"+this['id']+"'></td>"
 							+"<td style='text-align: center; color: #3A0756; font-size: 15px'>"+this['advertiserName']+"</td>"
 							+"<td style='text-align: center; color: #3A0756; font-size: 15px'>"+this['offerId']+"</td>"
 							+"<td style='text-align: center; color: #3A0756; font-size: 15px'>"+this['offerName'] +"</td>"	
 							+"<td style='text-align: center; color: #3A0756; font-size: 15px'>"+this['offerPriority'] +"</td>"
							+"</tr>" );
 							sno++;
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href="#"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Offer Priority </span></a></li>
			...
			<ul class="breadcrumb">
				...
				<li>
					<i class="icon-edit"></i>
					<a href="#">Offer Priority Details</a>
				</li>
			</ul>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon book"></i><span class="break"></span>Offer Priority Details </h2>
				...
				<table class="table table-striped table-bordered"  id="tbleData" >
								...
								<thead >
										<tr >
										  ...
										  <th style="text-align: center; color: red; font-size: 15px"> S No </th>
							
										  <th style="text-align: center; color: red; font-size: 15px">Advertiser Name </th>
										  
										  <th style="text-align: center; color: red; font-size: 15px">Offer ID </th>
										  
										  
										  <th style="text-align: center; color: red; font-size: 15px">Offer Name</th>
										  
										   <th style="text-align: center; color: red; font-size: 15px">Priority </th> 
